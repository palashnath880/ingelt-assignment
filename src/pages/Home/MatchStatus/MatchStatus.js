            ...
            <div className="">
                <div>
                    <ul className="flex text-white flex-wrap w-full gap-1.5 rounded-2xl overflow-hidden">
                        <li className='flex-1'>
                            <button onClick={() => setMatchCate('Cricket')} className={`${matchCate == 'Cricket' ? 'bg-violet-500' : 'bg-[#413F3F]'} w-full text-lg py-5 text-center bg-violet-500 font-semibold`} type="button">Cricket</button>
                        </li>
                        <li className='flex-1'>
                            <button onClick={() => setMatchCate('Football')} className={`${matchCate == 'Football' ? 'bg-violet-500' : 'bg-[#413F3F]'} w-full text-lg py-5 text-center font-semibold`} type="button">Football</button>
                        </li>
                        <li className='flex-1'>
                            <button onClick={() => setMatchCate('Tennis')} className={`${matchCate == 'Tennis' ? 'bg-violet-500' : 'bg-[#413F3F]'} w-full text-lg py-5 text-center font-semibold`} type="button">Tennis</button>
                        </li>
                    </ul>
                </div>
                <div className='mt-6'>
                            ...
                            <table className='table-fixed w-full rounded-2xl overflow-hidden'>
                                ...
                                <tbody>
                                    {matchs && matchs.map((match, index) =>
                                        <tr key={index} className='text-center odd:bg-[#343333] even:bg-[#29292E] text-lg font-bold text-white'>
                                            ...
                                            <td className='py-7'>{match?.team1}</td>
                                            <td className='py-7'>VS</td>
                                            <td className='py-7'>{match?.team2}</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
