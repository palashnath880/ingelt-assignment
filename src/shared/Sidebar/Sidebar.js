...
const Sidebar = () => {
    return (
        <aside className='border-l-4 border-[#20202D] px-10 min-h-screen'>
            <div className='border-b-2 border-[#20202D] pb-8'>
                <h2 className='text-white text-2xl font-bold py-5'>Popular Vidoes</h2>
                <div>
                    <img className='w-full h-auto' src={videoThumbnail} alt='Video Thumbnail' />
                </div>
            </div>
            <div>
                <h2 className='text-white text-2xl font-bold py-5'>Recent Updates</h2>
                <div className='pr-4'>
